    ...
    >
      <el-form :model="goods" label-width="150px" size="small">
        ...
        <el-form-item label="规格">
          <el-input
            v-model="goods.goodspackage"
            style="width: 250px"
          ></el-input>
        </el-form-item>
        <el-form-item label="包装">
          <el-input v-model="goods.size" style="width: 250px"></el-input>
        </el-form-item>
        <el-form-item label="生产批号">
          <el-input v-model="goods.productcode" style="width: 250px"></el-input>
        </el-form-item>
        <el-form-item label="批准文号">
          <el-input v-model="goods.promitcode" style="width: 250px"></el-input>
        </el-form-item>
        <el-form-item label="是否启用：">
          <el-radio-group v-model="goods.available">
...
<script>
import { getProductNameAndId } from "@/api/base_provide";
