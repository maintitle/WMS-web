<template>
  <div class="app-container">
        ...
        <transition name="fade">
          <div>
            ...
            <div>
              ...
              <el-checkbox v-model="showColumn.pid"
                >父级权限ID</el-checkbox
              >
    ...
    <el-dialog
      ...
      width="40%"
    >
      <el-form :model="permission" label-width="150px" size="small">
        ...
        <el-form-item label="权限名称：">
          <el-input v-model="permission.title" style="width: 250px"></el-input>
        </el-form-item>
        <el-form-item label="权限编码：">
          <el-input v-model="permission.percode" style="width: 250px"></el-input>
        </el-form-item>
        <el-form-item label="排序">
          <el-input v-model="permission.ordernum" style="width: 250px"></el-input>
        </el-form-item>
      </el-form>
